...
class TransactionFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        // Пользователь
        $user = $userRepository->findOneBy(['email' => 'artem@user.com']);
        ...
        $transactions = [
            ...
            [
                ...
                'expiresAt' => new \DateTimeImmutable('2022-07-19 00:00:00'),
            ...
            [
                'type' => 1,
                'amount' => $rentCourses[0]->getPrice(),
                'expiresAt' => new \DateTimeImmutable('2022-07-20 00:00:00'),
                'course' => $rentCourses[0],
                'customer' => $user,
        ...
        foreach ($transactions as $transaction) {
            ...
            $newTransaction->setUserBilling($transaction['customer']);
