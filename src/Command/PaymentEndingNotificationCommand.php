...
class PaymentEndingNotificationCommand extends Command
{
    ...
    public function __construct(Twig $twig, TransactionRepository $transactionRepository, UserRepository $userRepository, MailerInterface $mailer, string $name = null)
    {
        $this->twig = $twig;
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach ($users as $user) {
            $expiresTransactions = $this->transactionRepository->findRentalEndingCourses($user);
